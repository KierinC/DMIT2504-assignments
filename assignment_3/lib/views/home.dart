...
import 'dart:async';
import 'package:assignment_3/models/stock-list.dart';
import 'package:assignment_3/models/stock.dart';
import 'package:assignment_3/services/stock-service.dart';
import 'package:assignment_3/services/db-service.dart';
                ...
                onPressed: () async {
                  if (_stockSymbol.isNotEmpty) {
                    ...
                    try {
                      ...
                      var companyData = await _stockService.getCompanyInfo(symbol);
